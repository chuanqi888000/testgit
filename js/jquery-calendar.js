...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time" style="float:right;width:50%;margin-top:-17px;"><div class="select" style="width:37px;margin-left:30px;"><select id="calendar_hour" calss="gs" style="width:40px">';
            ...
            timeSelect += '</select></div><div class="select" style=" width:10px;">' + this.timeSeparators[1] + '</div> <div class="select" style="width:37px"><select id="calendar_minute" calss="gs" style="width:40px">';
            for (var a = 0; a <= 59; a++) {
        ...
        var html = (this.closeAtTop ? '<div id="calendar_control">' +
			...
			'<div id="calendar_header" style="float:left;width:50%;">';
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select" style="width:49px;margin-left:17px;"><select id="calendar_newYear" calss="gs" style="width:52px">';
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select" style="width:57px;"><select id="calendar_newMonth" calss="gs" style="width:60px">';
    ...
    showTime: function() {
        ...
        if (this.timeSeparators.length > 1) {
            ...
            if (this.timeSeparators.length == 4) {
                timeSelect += ' <div class="select"><select id="calendar_ampm" calss="gs">';
                timeSelect += '<option value="AM"' + ((this.selectedHour < 12) ? ' selected="selected"' : '') + '>' + this.timeSeparators[2] + '</option>';
                timeSelect += '<option value="PM"' + ((this.selectedHour >= 12) ? ' selected="selected"' : '') + '>' + this.timeSeparators[3] + '</option>';
                timeSelect += '</select></div>';
            }
